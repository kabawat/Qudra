                ...
                <button
                  ...
                  {contextData?.userData?.role === "client" && (
                    <NavLink to="/clientdashboard" style={{ color: "white" }}>
                      <i class="fa-solid fa-arrow-left-long pe-3"
                        style={{ fontSize: "30px" }}
                      ></i>
                    </NavLink>
                  )}
                  ...
                  {contextData?.userData?.role === "professional" && (
                    <NavLink to="/professionaldashboard" style={{ color: "white" }}>
                      <i class="fa-solid fa-arrow-left-long pe-3" style={{ fontSize: "30px" }}></i>
                    </NavLink>
                  )}
                </button>
                <div className="row">
                  <div className="col-lg-2 px-0 d-lg-block d-none">
                    <img src="/static/images/greenbgprofilepage1.png"
                      alt="" className="left-user-banner-image h-100 w-100" />
                  </div>
                  <div className="col-lg-10 px-0">
                    <img alt="" src="/static/images/userWork.png"
            ...
            <section className="profile-page-sec-two">
              <div className="container">
                <div className="row align-items-end">
                  <div className="col-lg-4">
                    <div className="user-profile-image w-100 h-100">
                      <img src={
                        ...
                        contextData?.professional_user_profile_data?.details?.user_image
                      } alt="" className="rounded-circle w-100" />
                  ...
                  <div className="col-lg-8 d-flex align-items-end bg-white"
                    style={{
                      zIndex: 999,
                      borderRadius: "14px",
