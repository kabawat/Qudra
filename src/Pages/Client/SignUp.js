...
const SignIn = () => {
  ...
  const verifyRequestButton = () => {
    ...
    axios.post("http://13.52.16.160:8082/identity/verify-email", { email: email, }).then((res) => {
  ...
  const handleOTPSubmit = (e) => {
    let email = $("#EmailInputSignUpForm").val();
    e.preventDefault();
    axios.put("http://13.52.16.160:8082/identity/verify-email", {
      email: email, otp: otp,
    }).then((res) => {
      if (res?.data?.status === "Success") {
                      ...
                      <div className="row">
                        <div className="col-md-3 col-xl-2 my-md-3 my-1">
                          <div>
                            ...
                            <span className={errdisplay} style={{ color: "red" }}>
                              profiel picture is required
                            </span>
                          </div>
                        </div>
                        <div className="col-9">
