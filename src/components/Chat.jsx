          ...
          <div className="container">
            <div className="row chats-header theme-bg-color" style={{ maxHeight: "inherit" }}>
              ...
              <div className="col-9 d-flex align-items-center p-2" style={{ minHeight: "61px" }}>
                <Avatar src={chatsUserTitle.userPic}
                  alt={"avatar"}
                  size="large"
                  type="rounded-circle" />
            ...
            <Tab.Container id="left-tabs-example"
              ...
              <Row className="chats-main" style={{ maxHeight: "100% " }}>
                <Col sm={3} id="chatusersdisplaybox" className="px-0"
                  style={{
                  ...
                  {!searchState ? (
                    ...
                    <Nav variant="pills" className="flex-column">
                      {allChatUser && allChatUser?.filter((data) =>
                        data?.name?.toLowerCase()?.includes(searchPara.toLowerCase())
                      ).map((data, index) => (
                        <>
                          {data?.name ? (
                            <ChatItem
                      ...
                      <div id="chat-log"
                        ...
                        <div className="row mx-0" ref={messageEndRef}>
                          <div className="col-10 d-flex">
                            <input className="chatMessageInputText"
