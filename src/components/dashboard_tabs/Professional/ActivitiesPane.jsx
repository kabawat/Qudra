...
const ActivitiesPane = () => {
  ...
  useEffect(() => {
    axios
      .post("http://13.52.16.160:8082/identity/projects", {
  ...
  useEffect(() => {
    contextData?.currentTab === "activities" &&
      searchActiveProject === "" &&
      axios
        .post("http://13.52.16.160:8082/identity/projects", {
          user_id: contextData?.userData?.user_id,
  ...
  }, [searchActiveProject, searchProjectPageId]);
            ...
            <div className="col-xxl-10 col-md-9 custom-border-radius-one  dashboard-theme-skyblue px-0 dashboard-right-section">
              ...
              <main className="dashboard-main">
                ...
                ></i> */}
                  ...
                  {searchActiveProject
                    ? searchProject &&
                    searchProject?.total_data > searchProjectPageId?.page_size && (
