                      ...
                      <div className="content pt-3">
                        <div className="profile_data mb-4">
                          <div className="left-image-data  "
                            ...
                            <img src={location?.state?.professional_image} alt="" width="100%" height="100%" />
                          </div>
                        ...
                        <div className="add-card-button">
                          <button className="left-button" type="button" onClick={() => setIsPayment(true)}>Add a new card</button>
                        </div>

                        <div className="choose-payment-button">
                          <button type="button" className="left-button" onClick={() => handalSubmit(true)}>Make a Payment</button>
                          <button type="button" className="left-button" onClick={handalBack}>Cancel</button>
                        </div>
                        {
