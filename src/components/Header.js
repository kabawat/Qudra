      ...
      <header className="dashboard-header bg-white custom-border-radius-one border-bottom">
        <div className="container ">
          <div className="row py-4">
            ...
            <div
              className="col-xxl-3 col-xl-4 col-lg-5 d-flex align-items-center justify-content-md-end justify-content-center flex-wrap"
              onClick={profileDropdown}
            >
              {cookies?.user_data?.role === "professional" ? (
                <div
    ...
    <>
      <header className="dashboard-header bg-white custom-border-radius-one">
        <div className="container-fluid px-lg-5 px-md-4 px-3">
          <div className="row py-4">
            <div className="col-xxl-9 col-xl-8 col-lg-8 col-10 d-block  d-flex align-items-center  justify-content-between dashboardMob ">
              <Link
                to={
                  cookies?.user_data?.role === "client"
                    ? "/clientdashboard"
            ...
            <div
              className="col-xxl-3 col-xl-4 col-lg-4 col-2 profile-mob d-flex align-items-center justify-content-md-end justify-content-center"
              onClick={profileDropdown}
            >
              {cookies?.user_data?.role === "professional" ? (
