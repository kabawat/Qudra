...
//   var setcolor = 0x01a78a;
//   //var setcolor = 0xF2F111;
//   //var setcolor = 0xFF6347;
//   var setcolor2 = 0x01aa8a;

//   scene.background = new THREE.Color(setcolor);
//   scene.fog = new THREE.Fog(setcolor2, 5, 16);
...
//   //       event.preventDefault();
//   //       mouse.x = event.touches[0].pageX - window.innerWidth / 102;
//   //       mouse.y = event.touches[0].pageY - window.innerHeight / 102;
//   //     }
//   //   }
...
//   var lightFront = new THREE.SpotLight(0xffffff, 10);
//   var lightBack = new THREE.PointLight(0xffffff, 7, 10);
...
//   var createCars = function (cScale = 2, cPos = 20, cColor = 0x01af81) {
